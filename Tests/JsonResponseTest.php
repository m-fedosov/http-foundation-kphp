...
class JsonResponseTest extends TestCase
{
    ...
    public function testSetEncodingOptions()
    {
        ...
        $this->markTestSkipped('The method has not yet been implemented');
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->markTestSkipped('This test needs a bug fix');
    ...
    public function testConstructorWithNullAsDataThrowsAnUnexpectedValueException()
    {
        ...
        $this->expectExceptionMessage('If $json is set to true, argument $data must be a string "NULL" given.');

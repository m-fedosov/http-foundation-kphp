...
class ResponseHeaderBagTest extends TestCase
{
    ...
    public function testCookiesWithSameNames()
    {
        ...
        $this->assertEquals(4, count($bag->getCookiesFlat()));
    ...
    public function testSetCookieHeader()
    {
        ...
        $this->assertEquals([Cookie::create('foo', 'bar', 0, '/', null, false, false, true, null)], $bag->getCookiesFlat());
        ...
        $this->assertEquals([], $bag->getCookiesFlat());
    }
...
//        $bag = new ResponseHeaderBag();
//
//        $bag->getCookiesFlat('invalid_argument');
//    }
